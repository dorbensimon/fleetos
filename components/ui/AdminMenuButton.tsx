 ...
 * corner. The notification bell used to live inside this dropdown — it
 * now sits next to this button instead (see NotificationBellButton),
 * so this menu only holds profile/departments/logout.
 */

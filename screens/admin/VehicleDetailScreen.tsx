...
const isVehicleTab = (value: unknown): value is Tab => value === 'general' || value === 'maintenance' || value === 'documents' || value === 'drivers';
...
export default function VehicleDetailScreen({ route, navigation }: Props) {
  ...
  const openDocumentFolder = (folder: (typeof VEHICLE_DOCUMENT_FOLDERS)[number]) => navigation.navigate('DocumentCategory', {

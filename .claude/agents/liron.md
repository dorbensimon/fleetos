...
לפני מחקר/עיצוב חדש: בדקי אם כבר קיים ב-`.claude/liron-design/` (persona/journey/wireframe רלוונטי) — עדכני קיים במקום ליצור כפילות. חיפוש בקוד — עדיף `graphify` על פני grep ידני כשהגרף קיים.
